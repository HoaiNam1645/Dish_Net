...
export const rankingPageData: Record<RankingTab, RankingTabConfig> = {
    ...
    foods: {
        ...
        columns: {
            primary: 'Món ăn',
            secondary: 'Food Reviewer',
            score: 'Đánh giá',
            metric: 'Đã bán',
        },
        rows: [
            { id: 'food-1', rank: 1, name: 'Trà sữa', secondaryName: 'Ăn vặt Food', secondaryLogo: '🍟', score: '4.9 ★ (500)', metric: '1.2k +', trend: 'up', href: '/ranking/food/food-1' },
            { id: 'food-2', rank: 2, name: 'Cơm', secondaryName: 'Khu AAAA', secondaryLogo: '👩', score: '4.9 ★ (500)', metric: '1.2k +', href: '/ranking/food/food-2' },
            { id: 'food-3', rank: 3, name: 'Cơm', secondaryName: 'Khu AAAA', secondaryLogo: '👩', score: '4.9 ★ (500)', metric: '1.2k +', href: '/ranking/food/food-3' },
            { id: 'food-4', rank: 4, name: 'Trà sữa', secondaryName: 'Ăn vặt Food', secondaryLogo: '🍟', score: '4.9 ★ (500)', metric: '1.2k +', trend: 'down', href: '/ranking/food/food-4' },
            { id: 'food-5', rank: 5, name: 'Trà sữa', secondaryName: 'Khu AAAA', secondaryLogo: '👩', score: '4.9 ★ (500)', metric: '1.2k +', href: '/ranking/food/food-5' },
            { id: 'food-6', rank: 6, name: 'Trà sữa', secondaryName: 'Ăn vặt Food', secondaryLogo: '🍟', score: '4.9 ★ (500)', metric: '1.2k +', trend: 'up', href: '/ranking/food/food-6' },
            { id: 'food-7', rank: 7, name: 'Trà sữa', secondaryName: 'Khu AAAA', secondaryLogo: '👩', score: '4.9 ★ (500)', metric: '1.2k +', href: '/ranking/food/food-7' },
            { id: 'food-8', rank: 8, name: 'Trà sữa', secondaryName: 'Ăn vặt Food', secondaryLogo: '🍟', score: '4.9 ★ (500)', metric: '1.2k +', href: '/ranking/food/food-8' },
            { id: 'food-9', rank: 9, name: 'Trà sữa', secondaryName: 'Khu AAAA', secondaryLogo: '👩', score: '4.9 ★ (500)', metric: '1.2k +', trend: 'up', href: '/ranking/food/food-9' },
            { id: 'food-10', rank: 10, name: 'Trà sữa', secondaryName: 'Ăn vặt Food', secondaryLogo: '🍟', score: '4.9 ★ (500)', metric: '1.2k +', href: '/ranking/food/food-10' },
        ],
    },
};
