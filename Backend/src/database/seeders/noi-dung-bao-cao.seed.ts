    ...
    [
      {
        ...
        mo_ta: 'Cửa hàng chuyên món Huế với các chương trình giảm giá theo tuần.',
        anh_dai_dien:
    ...
    [
      {
        ...
        id_cua_hang: 601,
        loai_bai_viet: 'video',
        noi_dung: 'Voucher giảm 50% toàn quán nhưng thực tế chỉ áp dụng cho một số món nhất định.',
    ...
    [
      {
        ...
        noi_dung: 'Bài này lặp lại quá nhiều lần, nhìn như spam và gây khó chịu trên feed.',
        trang_thai: 'hien_thi',
