  ...
  await repo.save([
    {
      ...
      noi_dung_yeu_cau: 'Tôi vừa thanh toán thành công nhưng đơn hàng bị hủy ngay sau đó. Nhờ hệ thống kiểm tra giúp nguyên nhân và hỗ trợ hoàn tiền.',
    ...
    },
    {
      ...
      noi_dung_yeu_cau: 'Tôi đã có đơn phát sinh từ link giới thiệu nhưng doanh thu và hoa hồng chưa được cập nhật trên hệ thống kiếm tiền.',
      trang_thai: 'chua_phan_hoi',
      id_admin_phan_hoi: null,
      noi_dung_phan_hoi: null,
    ...
    },
    {
      ...
      noi_dung_yeu_cau: 'Menu quán đã cập nhật từ hôm qua nhưng khách vẫn không nhìn thấy các món mới trên ứng dụng.',
      trang_thai: 'da_phan_hoi',
      id_admin_phan_hoi: getUserId(context, 'admin@dishnet.vn')!,
      noi_dung_phan_hoi: 'DishNet đã đồng bộ lại dữ liệu cửa hàng. Menu mới của bạn hiện đã hiển thị bình thường, vui lòng kiểm tra lại sau khi làm mới ứng dụng.',
    ...
    },
    {
      ...
      noi_dung_yeu_cau: 'Tôi thấy doanh thu creator hôm nay thấp hơn số đơn thực tế. Nhờ kiểm tra giúp phần tổng hợp báo cáo.',
      trang_thai: 'da_phan_hoi',
      id_admin_phan_hoi: getUserId(context, 'admin@dishnet.vn')!,
      noi_dung_phan_hoi: 'Chúng tôi đã rà lại dữ liệu và cập nhật báo cáo doanh thu. Số liệu hiện đã khớp với đơn hàng hoàn tất trong ngày.',
    ...
    },
    {
      ...
      noi_dung_yeu_cau: 'Tôi chọn món và thêm vào giỏ hàng được nhưng khi bấm đặt món thì hệ thống báo lỗi không xác định.',
      trang_thai: 'chua_phan_hoi',
      id_admin_phan_hoi: null,
      noi_dung_phan_hoi: null,
