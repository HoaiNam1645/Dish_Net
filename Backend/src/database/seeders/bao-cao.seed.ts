...
export async function seedBaoCao(context: SeederContext) {
  ...
  const reports = await baoCaoRepo.save([
    {
      ...
      noi_dung_bao_cao: 'Video quảng cáo giảm giá nhưng thực tế không đúng như mô tả trong bài đăng.',
      bang_chung_text: 'Người dùng cung cấp ảnh chụp menu thực tế và video màn hình nội dung bị báo cáo.',
    ...
    },
    {
      ...
      loai_vi_pham: 'Spam',
      noi_dung_bao_cao: 'Tài khoản này liên tục đăng nội dung spam và kéo tương tác không liên quan.',
      bang_chung_text: 'Nhiều bài viết lặp nội dung trong cùng ngày, ảnh chụp màn hình đã đính kèm.',
      trang_thai: 'cho_xu_ly',
      muc_do_vi_pham: null,
      ket_qua_xu_ly: null,
      hanh_dong_ap_dung: null,
    ...
    },
    {
      ...
      noi_dung_bao_cao: 'Cửa hàng xác nhận khuyến mãi nhưng từ chối áp dụng khi khách đến nhận món.',
      bang_chung_text: 'Có ảnh chụp tin nhắn xác nhận khuyến mãi và hóa đơn thanh toán thực tế.',
      trang_thai: 'da_xu_ly',
      muc_do_vi_pham: 'trung_binh',
      ket_qua_xu_ly: 'Gửi cảnh cáo',
      hanh_dong_ap_dung: JSON.stringify(['Gửi cảnh báo tài khoản', 'Gửi thông báo cho tài khoản vi phạm']),
      gui_canh_bao: true,
    ...
    },
    {
      ...
      noi_dung_bao_cao: 'Người dùng đăng khiếu nại sai sự thật về món ăn và gây ảnh hưởng đến uy tín cửa hàng.',
      bang_chung_text: 'Đã đính kèm ảnh món ăn thực tế và lịch sử đơn hàng để đối chiếu.',
      trang_thai: 'da_xu_ly',
      muc_do_vi_pham: 'nhe',
      ket_qua_xu_ly: 'Từ chối báo cáo',
      hanh_dong_ap_dung: JSON.stringify(['Gửi thông báo cho tài khoản vi phạm']),
      gui_canh_bao: true,
      id_admin_xu_ly: getUserId(context, 'admin@dishnet.vn')!,
  ...
  context.reportByCode = new Map(reports.map((item) => [item.ma_bao_cao, item]));
  ...
  const attachments = [
    {
      ...
      loai_tep: 'hinh_anh',
      duong_dan_tep: 'https://images.unsplash.com/photo-1515003197210-e0cd71810b5f',
      thu_tu_hien_thi: 1,
    ...
    },
    {
      ...
      loai_tep: 'hinh_anh',
      duong_dan_tep: 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f',
      thu_tu_hien_thi: 1,
